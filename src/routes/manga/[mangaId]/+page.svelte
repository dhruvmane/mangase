...
<main class="m-2 p-2">
     ...
     <div class="">
          ...
          <div class="flex flex-col gap-3 mt-2 bg-black rounded-2xl p-4 md:max-w-md lg:max-w-lg xl:max-w-xl m-auto w-full">
               <!-- Manga Description -->
               ...
               <!-- Tags -->
               <div class="flex gap-1 flex-wrap items-center rounded-2xl">
